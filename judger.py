...
def rundocker(judging):
    ...
    if judging.problem.test=="":
        if judging.lang == "python3":
            bash = "\"> tmp/code/error.txt;python3 tmp/code/* > tmp/code/out.txt 2>>tmp/code/error.txt\""
        elif judging.lang == "c++":
            bash = "\"> tmp/code/error.txt;g++ tmp/code/*.cpp -o tmp/code/a.exe 2> tmp/code/error.txt;tmp/code/a.exe > tmp/code/out.txt 2>> tmp/code/error.txt\""
    else:
        if judging.lang == "python3":
            bash = "\"> tmp/code/error.txt;python3 tmp/code/* < tmp/problem/test.txt > tmp/code/out.txt 2>>tmp/code/error.txt\""
        elif judging.lang == "c++":
            bash = "\"> tmp/code/error.txt;g++ tmp/code/*.cpp -o tmp/code/a.exe 2> tmp/code/error.txt;tmp/code/a.exe < tmp/problem/test.txt > tmp/code/out.txt 2>>tmp/code/error.txt\""
